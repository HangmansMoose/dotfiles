...
# Clone zvm
Write-Host "Grabbing ZVM"
$zvmUrl = "https://github.com/tristanisham/zvm.git"
$zvmTarget = "$HOME\.zvm"

git clone $zvmUrl $zvmTarget

# Refresh Environment Variables
$env:Path = [System.Environment]::GetEnvironmentVariable("Path", "Machine") + ";" + [System.Environment]::GetEnvironmentVariable("Path", "User")

Write-Host "Installing Zig 0.15.1 and Master"
zvm install --zls "0.15.1"
zvm install --zls "master"

Write-Host "Setting Zig 0.15.1 as use version"
zvm use "0.15.1"
